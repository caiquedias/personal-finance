...
namespace PersonalFinance.Infrastructure.Migrations
{
    ...
    [Migration("20260626180104_AddPurgeModule")]
    partial class AddPurgeModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalFinance.Domain.Entities.Financial.ExpenseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("ExpenseOrder", (string)null);
                });
            ...
            modelBuilder.Entity("PersonalFinance.Domain.Entities.Financial.PurgeRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");

                    b.Property<string>("CategorySummaryJson")
                        .IsRequired()
                    ...
                    b.ToTable("PurgeRecord", (string)null);
                });
            ...
            modelBuilder.Entity("PersonalFinance.Domain.Entities.Financial.Expense", b =>
                {
                    ...
                    b.HasOne("PersonalFinance.Domain.Entities.Financial.Expense", null)
                        .WithMany()
