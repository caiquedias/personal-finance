...
public sealed class CategoryRepository : ICategoryRepository
{
    ...
    public async Task<Category?> GetByIdAndUserAsync(
        ...
        => await _context.Categories
               .FirstOrDefaultAsync(
                   c => c.Id == id && (c.IsGlobal || c.UserId == userId), ct);
    ...
    /// <summary>
    /// Retorna categoria global pelo nome exato (case-insensitive).
    /// Usado durante a importação legada para evitar duplicatas.
    /// </summary>
    public async Task<Category?> GetGlobalByNameAsync(
